...
class PrivateBusOptions {
  ...
  PrivateBusOptions._(this.routeOptions, this.textOptions, this.avoidanceOptions, this.maxSpeedOnSegments, this.busSpecifications);
  /// Creates a new instance.
  PrivateBusOptions()
...
Pointer<Void> sdkRoutingPrivatebusoptionsToFfi(PrivateBusOptions value) {
  ...
  final _result = _sdkRoutingPrivatebusoptionsCreateHandle(_routeOptionsHandle, _textOptionsHandle, _avoidanceOptionsHandle, _maxSpeedOnSegmentsHandle, _busSpecificationsHandle);
