...
class LocalizedRoadNumbers$Impl {
  String? getPreferredValueForLocales(LocalizedRoadNumbers $that, List<Locale> locales) {
    ...
    final _localesHandle = heresdkRoutingCommonBindingslistofLocaleToFfi(locales);
    ...
    heresdkRoutingCommonBindingslistofLocaleReleaseFfiHandle(_localesHandle);
    try {
...
Pointer<Void> sdkRoutingLocalizedroadnumbersToFfi(LocalizedRoadNumbers value) {
  final _itemsHandle = heresdkRoutingCommonBindingslistofSdkRoutingLocalizedroadnumberToFfi(value.items);
  final _result = _sdkRoutingLocalizedroadnumbersCreateHandle(_itemsHandle);
  heresdkRoutingCommonBindingslistofSdkRoutingLocalizedroadnumberReleaseFfiHandle(_itemsHandle);
  return _result;
}
...
LocalizedRoadNumbers sdkRoutingLocalizedroadnumbersFromFfi(Pointer<Void> handle) {
  ...
  try {
    return LocalizedRoadNumbers._(
      heresdkRoutingCommonBindingslistofSdkRoutingLocalizedroadnumberFromFfi(_itemsHandle)
    );
  } finally {
    heresdkRoutingCommonBindingslistofSdkRoutingLocalizedroadnumberReleaseFfiHandle(_itemsHandle);
  }
