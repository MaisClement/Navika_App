...
// RER
                ...
                children: [
                  Container(
                    ...
                    width: 45,
                    height: 45,
                    child: const Image(image: AssetImage('assets/icons/RER_dark.png'))
                  ),
                  Expanded(
                    child: Wrap( 
                        children: const [
      ...
      Row( 
        children: [
          Container(
            ...
            width: 45,
            height: 45,
            child: const Image(image: AssetImage('assets/icons/TRAIN_dark.png'))
          ),
          Expanded(
            child: Wrap( 
              children: const [
      ...
      Row( 
        children: [
          Container(
            ...
            width: 45,
            height: 45,
            child: const Image(image: AssetImage('assets/icons/METRO_dark.png'))
          ),
          Expanded(
            child: Wrap( 
              children: const [
      ...
      Row( 
        children: [
          Container(
            ...
            width: 45,
            height: 45,
            child: const Image(image: AssetImage('assets/icons/TRAM_dark.png'))
          ),
          Expanded(
            child: Wrap( 
              children: const [
