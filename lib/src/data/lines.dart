...
..addLine('C01742', 'RER A', 'RER A', AssetImage('assets/idfm/lines_small_dark/RER_A.png'), 'RER', AssetImage('assets/idfm/RER_dark.png'), AssetImage('assets/idfm/RER_white.png'))
..addLine('C01743', 'RER B', 'RER B', AssetImage('assets/idfm/lines_small_dark/RER_B.png'), 'RER', AssetImage('assets/idfm/RER_dark.png'), AssetImage('assets/idfm/RER_white.png'))
..addLine('C01727', 'RER C', 'RER C', AssetImage('assets/idfm/lines_small_dark/RER_C.png'), 'RER', AssetImage('assets/idfm/RER_dark.png'), AssetImage('assets/idfm/RER_white.png'))
..addLine('C01728', 'RER D', 'RER D', AssetImage('assets/idfm/lines_small_dark/RER_D.png'), 'RER', AssetImage('assets/idfm/RER_dark.png'), AssetImage('assets/idfm/RER_white.png'))
..addLine('C01729', 'RER E', 'RER E', AssetImage('assets/idfm/lines_small_dark/RER_E.png'), 'RER', AssetImage('assets/idfm/RER_dark.png'), AssetImage('assets/idfm/RER_white.png'))

..addLine('C01371', 'METRO 1',  'Métro 1',  AssetImage('assets/idfm/lines_small_dark/METRO_1.png'),   'METRO', AssetImage('assets/idfm/METRO_dark.png'), AssetImage('assets/idfm/METRO_white.png'))
..addLine('C01372', 'METRO 2',  'Métro 2',  AssetImage('assets/idfm/lines_small_dark/METRO_2.png'),   'METRO', AssetImage('assets/idfm/METRO_dark.png'), AssetImage('assets/idfm/METRO_white.png'))
..addLine('C01373', 'METRO 3',  'Métro 3',  AssetImage('assets/idfm/lines_small_dark/METRO_3.png'),   'METRO', AssetImage('assets/idfm/METRO_dark.png'), AssetImage('assets/idfm/METRO_white.png'))
..addLine('C01386', 'METRO 3B', 'Métro 3B', AssetImage('assets/idfm/lines_small_dark/METRO_3B.png'),  'METRO', AssetImage('assets/idfm/METRO_dark.png'), AssetImage('assets/idfm/METRO_white.png'))
..addLine('C01374', 'METRO 4',  'Métro 4',  AssetImage('assets/idfm/lines_small_dark/METRO_4.png'),   'METRO', AssetImage('assets/idfm/METRO_dark.png'), AssetImage('assets/idfm/METRO_white.png'))
..addLine('C01375', 'METRO 5',  'Métro 5',  AssetImage('assets/idfm/lines_small_dark/METRO_5.png'),   'METRO', AssetImage('assets/idfm/METRO_dark.png'), AssetImage('assets/idfm/METRO_white.png'))
..addLine('C01376', 'METRO 6',  'Métro 6',  AssetImage('assets/idfm/lines_small_dark/METRO_6.png'),   'METRO', AssetImage('assets/idfm/METRO_dark.png'), AssetImage('assets/idfm/METRO_white.png'))
..addLine('C01377', 'METRO 7',  'Métro 7',  AssetImage('assets/idfm/lines_small_dark/METRO_7.png'),   'METRO', AssetImage('assets/idfm/METRO_dark.png'), AssetImage('assets/idfm/METRO_white.png'))
..addLine('C01387', 'METRO 7B', 'Métro 7B', AssetImage('assets/idfm/lines_small_dark/METRO_7B.png'),  'METRO', AssetImage('assets/idfm/METRO_dark.png'), AssetImage('assets/idfm/METRO_white.png'))
..addLine('C01378', 'METRO 8',  'Métro 8',  AssetImage('assets/idfm/lines_small_dark/METRO_8.png'),   'METRO', AssetImage('assets/idfm/METRO_dark.png'), AssetImage('assets/idfm/METRO_white.png'))
..addLine('C01379', 'METRO 9',  'Métro 9',  AssetImage('assets/idfm/lines_small_dark/METRO_9.png'),   'METRO', AssetImage('assets/idfm/METRO_dark.png'), AssetImage('assets/idfm/METRO_white.png'))
..addLine('C01380', 'METRO 10', 'Métro 10', AssetImage('assets/idfm/lines_small_dark/METRO_10.png'),  'METRO', AssetImage('assets/idfm/METRO_dark.png'), AssetImage('assets/idfm/METRO_white.png'))
..addLine('C01381', 'METRO 11', 'Métro 11', AssetImage('assets/idfm/lines_small_dark/METRO_11.png'),  'METRO', AssetImage('assets/idfm/METRO_dark.png'), AssetImage('assets/idfm/METRO_white.png'))
..addLine('C01382', 'METRO 12', 'Métro 12', AssetImage('assets/idfm/lines_small_dark/METRO_12.png'),  'METRO', AssetImage('assets/idfm/METRO_dark.png'), AssetImage('assets/idfm/METRO_white.png'))
..addLine('C01383', 'METRO 13', 'Métro 13', AssetImage('assets/idfm/lines_small_dark/METRO_13.png'),  'METRO', AssetImage('assets/idfm/METRO_dark.png'), AssetImage('assets/idfm/METRO_white.png'))
..addLine('C01384', 'METRO 14', 'Métro 14', AssetImage('assets/idfm/lines_small_dark/METRO_14.png'),  'METRO', AssetImage('assets/idfm/METRO_dark.png'), AssetImage('assets/idfm/METRO_white.png'))

..addLine('C01388', 'Orly val', 'Orly val', AssetImage('assets/Val/ORLYVAL.png'),  'METRO', AssetImage('assets/null.png'), AssetImage('assets/null.png'))
..addLine('C00563', 'CDG Val', 'CDG Val', AssetImage('assets/idfm/lines_small_dark/METRO_14.png'),  'METRO', AssetImage('assets/null.png'), AssetImage('assets/null.png'))

..addLine('C01389', 'T1', 'Tram T1',    AssetImage('assets/idfm/lines_small_dark/TRAM_1.png'),  'TRAM', AssetImage('assets/idfm/TRAM_dark.png'), AssetImage('assets/idfm/TRAM_white.png'))
..addLine('C01390', 'T2', 'Tram T2',    AssetImage('assets/idfm/lines_small_dark/TRAM_2.png'),  'TRAM', AssetImage('assets/idfm/TRAM_dark.png'), AssetImage('assets/idfm/TRAM_white.png'))
..addLine('C01391', 'T3A', 'Tram T3a',  AssetImage('assets/idfm/lines_small_dark/TRAM_3A.png'), 'TRAM', AssetImage('assets/idfm/TRAM_dark.png'), AssetImage('assets/idfm/TRAM_white.png'))
..addLine('C01679', 'T3B', 'Tram T3b',  AssetImage('assets/idfm/lines_small_dark/TRAM_3B.png'), 'TRAM', AssetImage('assets/idfm/TRAM_dark.png'), AssetImage('assets/idfm/TRAM_white.png'))
..addLine('C01843', 'T4', 'Tram T4',    AssetImage('assets/idfm/lines_small_dark/TRAM_4.png'),  'TRAM', AssetImage('assets/idfm/TRAM_dark.png'), AssetImage('assets/idfm/TRAM_white.png'))
..addLine('C01684', 'T5', 'Tram T5',    AssetImage('assets/idfm/lines_small_dark/TRAM_5.png'),  'TRAM', AssetImage('assets/idfm/TRAM_dark.png'), AssetImage('assets/idfm/TRAM_white.png'))
..addLine('C01794', 'T6', 'Tram T6',    AssetImage('assets/idfm/lines_small_dark/TRAM_6.png'),  'TRAM', AssetImage('assets/idfm/TRAM_dark.png'), AssetImage('assets/idfm/TRAM_white.png'))
..addLine('C01774', 'T7', 'Tram T7',    AssetImage('assets/idfm/lines_small_dark/TRAM_7.png'),  'TRAM', AssetImage('assets/idfm/TRAM_dark.png'), AssetImage('assets/idfm/TRAM_white.png'))
..addLine('C01795', 'T8', 'Tram T8',    AssetImage('assets/idfm/lines_small_dark/TRAM_8.png'),  'TRAM', AssetImage('assets/idfm/TRAM_dark.png'), AssetImage('assets/idfm/TRAM_white.png'))
..addLine('C02317', 'T9', 'Tram T9',    AssetImage('assets/idfm/lines_small_dark/TRAM_9.png'),  'TRAM', AssetImage('assets/idfm/TRAM_dark.png'), AssetImage('assets/idfm/TRAM_white.png'))
..addLine('C01999', 'T11', 'Tram T11',  AssetImage('assets/idfm/lines_small_dark/TRAM_11.png'), 'TRAM', AssetImage('assets/idfm/TRAM_dark.png'), AssetImage('assets/idfm/TRAM_white.png'))
..addLine('C02344', 'T13', 'Tram T13',  AssetImage('assets/idfm/lines_small_dark/TRAM_13.png'), 'TRAM', AssetImage('assets/idfm/TRAM_dark.png'), AssetImage('assets/idfm/TRAM_white.png'))

..addLine('C01737', 'TRANSILIEN H', 'Transilien H', AssetImage('assets/idfm/lines_small_dark/TRAIN_H.png'), 'TRAIN', AssetImage('assets/idfm/TRAIN_dark.png'), AssetImage('assets/idfm/TRAIN_white.png'))
..addLine('C01739', 'TRANSILIEN J', 'Transilien J', AssetImage('assets/idfm/lines_small_dark/TRAIN_J.png'), 'TRAIN', AssetImage('assets/idfm/TRAIN_dark.png'), AssetImage('assets/idfm/TRAIN_white.png'))
..addLine('C01738', 'TRANSILIEN K', 'Transilien K', AssetImage('assets/idfm/lines_small_dark/TRAIN_K.png'), 'TRAIN', AssetImage('assets/idfm/TRAIN_dark.png'), AssetImage('assets/idfm/TRAIN_white.png'))
..addLine('C01740', 'TRANSILIEN L', 'Transilien L', AssetImage('assets/idfm/lines_small_dark/TRAIN_L.png'), 'TRAIN', AssetImage('assets/idfm/TRAIN_dark.png'), AssetImage('assets/idfm/TRAIN_white.png'))
..addLine('C01736', 'TRANSILIEN N', 'Transilien N', AssetImage('assets/idfm/lines_small_dark/TRAIN_N.png'), 'TRAIN', AssetImage('assets/idfm/TRAIN_dark.png'), AssetImage('assets/idfm/TRAIN_white.png'))
..addLine('C01730', 'TRANSILIEN P', 'Transilien P', AssetImage('assets/idfm/lines_small_dark/TRAIN_P.png'), 'TRAIN', AssetImage('assets/idfm/TRAIN_dark.png'), AssetImage('assets/idfm/TRAIN_white.png'))
..addLine('C01731', 'TRANSILIEN R', 'Transilien R', AssetImage('assets/idfm/lines_small_dark/TRAIN_R.png'), 'TRAIN', AssetImage('assets/idfm/TRAIN_dark.png'), AssetImage('assets/idfm/TRAIN_white.png'))
..addLine('C01741', 'TRANSILIEN U', 'Transilien U', AssetImage('assets/idfm/lines_small_dark/TRAIN_U.png'), 'TRAIN', AssetImage('assets/idfm/TRAIN_dark.png'), AssetImage('assets/idfm/TRAIN_white.png'))
