...
..addLine('C01744', 'TER', 'TER Centre - Val de Loire', const AssetImage('assets/sncf/TER_color.png'),  'TER', const AssetImage('assets/sncf/TER_dark.png'), const AssetImage('assets/sncf/TER_white.png'))
..addLine('C01863', 'TER', 'TER Hauts-de-France', const AssetImage('assets/sncf/TER_color.png'),  'TER', const AssetImage('assets/sncf/TER_dark.png'), const AssetImage('assets/sncf/TER_white.png'))
..addLine('C01747', 'TER', 'TER Grand-Est', const AssetImage('assets/sncf/TER_color.png'),  'TER', const AssetImage('assets/sncf/TER_dark.png'), const AssetImage('assets/sncf/TER_white.png'))
..addLine('C02375', 'TER', 'TER Normandie', const AssetImage('assets/sncf/TER_color.png'),  'TER', const AssetImage('assets/sncf/TER_dark.png'), const AssetImage('assets/sncf/TER_white.png'))
..addLine('C01745', 'TER', 'TER Bourgogne - Franche-Comté', const AssetImage('assets/sncf/TER_color.png'),  'TER', const AssetImage('assets/sncf/TER_dark.png'), const AssetImage('assets/sncf/TER_white.png'))
..addLine('C02368', 'TER', 'TER Centre - Val de Loire', const AssetImage('assets/sncf/TER_color.png'),  'TER', const AssetImage('assets/sncf/TER_dark.png'), const AssetImage('assets/sncf/TER_white.png'))
..addLine('C02372', 'TER', 'TER Hauts-de-France', const AssetImage('assets/sncf/TER_color.png'),  'TER', const AssetImage('assets/sncf/TER_dark.png'), const AssetImage('assets/sncf/TER_white.png'))
..addLine('C02370', 'TER', 'TER Normandie', const AssetImage('assets/sncf/TER_color.png'),  'TER', const AssetImage('assets/sncf/TER_dark.png'), const AssetImage('assets/sncf/TER_white.png'))
..addLine('C01748', 'TER', 'TER Normandie', const AssetImage('assets/sncf/TER_color.png'),  'TER', const AssetImage('assets/sncf/TER_dark.png'), const AssetImage('assets/sncf/TER_white.png'))
..addLine('C01857', 'TER', 'TER Centre - Val-de-Loire', const AssetImage('assets/sncf/TER_color.png'),  'TER', const AssetImage('assets/sncf/TER_dark.png'), const AssetImage('assets/sncf/TER_white.png'))
..addLine('C01746', 'TER', 'TER Hauts-de-Franche', const AssetImage('assets/sncf/TER_color.png'),  'TER', const AssetImage('assets/sncf/TER_dark.png'), const AssetImage('assets/sncf/TER_white.png'))

..addLine('TER', 'TER', 'TER', const AssetImage('assets/sncf/TER_color.png'),  'TER', const AssetImage('assets/sncf/TER_dark.png'), const AssetImage('assets/sncf/TER_white.png'))
